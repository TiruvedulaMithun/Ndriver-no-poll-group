...
import com.mithun.trail18.BTrail18Network;

/**
 * BTrail18LearnDevicesJob - This job is used by the access device manager to discover connected
 * access devices.
 *
...
public class BTrail18LearnDevicesJob
  extends BSimpleJob
{
//region /*+ ------------ BEGIN BAJA AUTO GENERATED CODE ------------ +*/
//@formatter:off
/*@ $com.mithun.trail18.learn.BTrail18LearnDevicesJob(3804438489)1.0$ @*/
/* Generated Tue May 27 14:42:36 EDT 2025 by Slot-o-Matic (c) Tridium, Inc. 2012-2025 */
  ...
  public static final Type TYPE = Sys.loadType(BTrail18LearnDevicesJob.class);
...
//endregion /*+ ------------ END BAJA AUTO GENERATED CODE -------------- +*/
  /**
   * Constructor - BTrail18LearnDevicesJob
   */
  public BTrail18LearnDevicesJob()
  {
    this(null);
  }
   ...
   * Constructor - BTrail18LearnDevicesJob
   */
  public BTrail18LearnDevicesJob(BTrail18Network net)
  {
    super();
    this.network = net;
  }
  ...
  void addLearnedDevice(String address)
  {
    ...
    {
      getLearnedDevices().add(learnName, new BTrail18LearnDeviceEntry(address));
    ...
    throws Exception
  {
    ...
    try
    {
      ...
      *  You will need to modify the BTrail18LearnDeviceEntry to match the key data items to
      *  identify this device.
      *  You will need to modify addLearnedDevice to create and add an instance of
      *  BTrail18LearnDeviceEntry.
