...
/**
 * BTrail18PointDiscoveryLeaf is container class for point elements to display in
...
public class BTrail18PointDiscoveryLeaf
  extends BNPointDiscoveryLeaf
{
//region /*+ ------------ BEGIN BAJA AUTO GENERATED CODE ------------ +*/
//@formatter:off
/*@ $com.mithun.trail18.point.BTrail18PointDiscoveryLeaf(1643154273)1.0$ @*/
/* Generated Tue May 27 15:00:21 EDT 2025 by Slot-o-Matic (c) Tridium, Inc. 2012-2025 */
  ...
  public static final Type TYPE = Sys.loadType(BTrail18PointDiscoveryLeaf.class);

  //endregion Type

//@formatter:on
//endregion /*+ ------------ END BAJA AUTO GENERATED CODE -------------- +*/
  public BTrail18PointDiscoveryLeaf()
  {
  }
...
//    }
  ...
  public void updateTarget(BComponent target)
  {
    ...
    BTrail18ProxyExt pext = new BTrail18ProxyExt();
  ...
  public boolean isExisting(BComponent target)
  {
    ...
    BControlPoint cp = (BControlPoint) target;
    BTrail18ProxyExt pext = (BTrail18ProxyExt) cp.getProxyExt();
    //
