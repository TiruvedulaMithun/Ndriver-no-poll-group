...
/**
 * Trail18SerialLinkMessage streams data to and from a byte array representation.
 *
 * @author mithun on 27 May 2025
 */
public class Trail18SerialLinkMessage
  extends LinkMessage
{
  public Trail18SerialLinkMessage(int maxLen)
  {
    super(maxLen);
  }
